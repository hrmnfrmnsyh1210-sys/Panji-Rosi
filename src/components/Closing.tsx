...
export default function Closing() {
  return (
    <section className="py-24 px-6 bg-slate-950 text-slate-50 text-center relative overflow-hidden">
      {/* Background Image */}
      ...
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-slate-950 via-slate-950/80 to-slate-900/90" />
      ...
      <div className="max-w-2xl mx-auto relative z-10 flex flex-col items-center mt-12">
        ...
        >
          ...
          <p className="font-sans text-slate-100 leading-relaxed text-sm md:text-base mb-8 max-w-lg">
          ...
          <p className="font-sans text-slate-300 text-sm uppercase tracking-[0.3em] mb-6 font-semibold">
            Kami yang berbahagia
          </p>
          <h2 className="font-cursive text-6xl md:text-7xl text-slate-50 drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)]">
