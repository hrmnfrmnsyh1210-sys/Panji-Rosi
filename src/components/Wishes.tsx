...
const APPS_SCRIPT_URL = (import.meta.env.VITE_APPS_SCRIPT_URL as string) || "https://script.google.com/macros/s/AKfycbziu3L5mUSCyxp5pOLTkzSmJNPw3os7pUfTU-I55gXwyTwrmS-MzltWtP0bGXSQMFY/exec";
