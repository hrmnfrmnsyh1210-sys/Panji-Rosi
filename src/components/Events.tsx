...
export default function Events() {
  return (
    <section className="py-24 px-6 bg-emerald-950 text-emerald-50 relative overflow-hidden">
      {/* Background Image */}
      ...
      <div className="absolute inset-0 z-0 bg-emerald-950/80" />
      
      <MotifTenunBackground opacity="0.15" />
      
      <div className="absolute top-0 w-full z-10 left-0">
        <MotifPucukRebung position="bottom" className="text-emerald-900 opacity-50" />
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10 mt-8">
        ...
        >
          ...
          <p className="font-sans text-emerald-200 uppercase tracking-[0.2em] text-sm font-medium">Rangkaian Acara</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            className="bg-emerald-900/60 p-8 rounded-tl-[3rem] rounded-br-[3rem] rounded-tr-xl rounded-bl-xl border border-amber-500/30 flex flex-col items-center text-center backdrop-blur-md shadow-xl relative overflow-hidden group hover:border-amber-400/50 transition-colors"
          >
            ...
            <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center mb-6 shadow-lg z-10">
              <Calendar className="w-8 h-8 text-emerald-950" />
            </div>
            <h3 className="font-serif text-3xl mb-6 text-amber-100 z-10">Akad Nikah</h3>
            <div className="flex flex-col gap-4 w-full z-10">
              <div className="flex items-center justify-center gap-3 text-emerald-50">
                <span className="font-sans font-semibold text-base md:text-lg tracking-wide">{WeddingData.akad.date}</span>
              </div>
              <div className="flex items-center justify-center gap-3 text-emerald-200 bg-emerald-950/30 py-2 px-4 rounded-full mx-auto w-fit">
                <Clock className="w-4 h-4 text-amber-400" />
                <span className="font-sans text-sm font-medium">{WeddingData.akad.time}</span>
              </div>
              <div className="flex items-start justify-center gap-3 text-emerald-200 mt-2">
          ...
          <motion.div
            ...
            className="bg-emerald-900/60 p-8 rounded-tr-[3rem] rounded-bl-[3rem] rounded-tl-xl rounded-br-xl border border-amber-500/30 flex flex-col items-center text-center backdrop-blur-md shadow-xl relative overflow-hidden group hover:border-amber-400/50 transition-colors"
          >
            ...
            <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center mb-6 shadow-lg z-10">
              <MapPin className="w-8 h-8 text-emerald-950" />
            </div>
            ...
            <a 
              ...
              className="mt-8 inline-flex items-center gap-2 bg-amber-500 text-emerald-950 px-6 py-3 rounded-full font-sans font-bold hover:bg-amber-400 transition-colors z-10 shadow-lg"
            >
